          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="p-6 overflow-y-auto custom-scrollbar">
                <div
                  className="prose prose-lg leading-[1.5] dark:prose-invert text-[15px] max-w-none font-inter text-slate-300 [&_strong]:text-slate-100 [&_p]:my-1 [&_h1]:my-1 [&_h2]:my-1 [&_ul]:my-1 [&_ol]:my-1"
